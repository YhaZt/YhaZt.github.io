...
const defaultHero = {
  ...
  email: 'mailto:carpelbalmes@gmail.com',
};
...
const defaultStats = [
  ...
  { id: '2', icon: 'Briefcase', value: 4, suffix: '', label: 'Projects Shipped', sort_order: 1 },
...
const defaultProjects = [
  {
    id: '1',
    title: 'Alapaw',
    description: 'Commute and transportation companion (Komyut) — route planning, fare tracking, and commuter-focused features for everyday travel.',
  ...
  },
  {
    id: '2',
    title: 'MinSU iBIBES',
    description: 'Food ordering platform for MinSU — browse menus, place orders, and manage restaurant interactions on campus.',
  ...
  },
  {
    id: '3',
    title: 'Rite',
    description: 'Official institutional website for RITE — modern frontend with Vue.js, responsive layout, and clean content structure.',
  ...
  },
  {
    id: '4',
    title: 'Arawatan',
    description: 'Web application built for streamlined workflows, user management, and a polished interface for everyday operations.',
